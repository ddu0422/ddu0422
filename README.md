...
### "비즈니스 가치를 설계하고 아키텍처로 증명하는 개발자"

<br />

## 🚀 About Me
- **Business:** 비즈니스 임팩트를 최우선으로 고민하며 기술로 해답을 제시합니다.
- **Problem Solver:** 단순히 기술적으로 문제를 해결하는 것이 아니라 **본질을 꿰뚫는 방법**으로 문제를 해결합니다.
- **Data Driven:** 모든 해결 과정은 객관적인 지표로 증명합니다. 기술이 어떻게 비즈니스의 수익으로 연결되는지 숫자로 확인합니다.
- **Philosophy:** **OOP, Clean Code, TDD**를 기반으로 '왜(Why?)'를 고민하며 지속 가능한 코드를 작성합니다.
- **Mentoring:** 우아한테크코스 4기, 6기 리뷰어로 활동하며 동료의 성장을 돕는 문화를 즐깁니다.
...
- **조직 리딩**: PLE로서 [팀 자율 의사결정 기반의 개발 조직 체계 구축](https://dhistory.tistory.com/273)
- **안정성 개선**: 레거시 시스템을 개선하여 **SLA 달성률을 70% → 99.9%로 향상**시키고 장애를 대폭 감소시켜 최대 월 매출 3억 달성에 기여

### **비엔디알에스(주)** (2023.11 ~ 2024.04)
- **성능 개선:** No-offset 적용으로 **조회 성능 85% 향상 (4초 → 0.6초)** & QueryDSL 전환으로 4건의 N+1 문제 해결
- **안정성 개선:** ECS Rolling Update 기반 **24/7 무중단 서비스** 운영 및 롤백 프로세스 최적화 **(15분 → 3분)**

### **(주)클래스101** (2020.11 ~ 2023.07)
- **비용 최적화:** 로그 감사를 진행하여 **운영 비용 99% 절감 (월 2,600만원 → 1만원)**
- **아키텍처 개선:** 회원 서비스 MSA 전환하여 **배포 시간 83% 단축 (90분 → 15분)** 및 Feature Flag 도입으로 롤백 시간 93% 단축
- **비즈니스 성과:** B tv QR 로그인 기능 런칭으로 **신규 매출 월 1,000만원** 견인 및 260만 유저 데이터 Batch 처리
