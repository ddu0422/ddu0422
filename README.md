...
- **Community:** 우아한테크코스 4기, 6기 리뷰어로 활동하며 동료의 성장을 돕는 문화를 즐깁니다.
...
- **비용 혁신:** 로그 감사 및 K8s 리소스 최적화로 **운영 비용 99% 절감 (월 2,600만원 → 1만원)**
- **아키텍처:** 회원 서비스 MSA 전환하여 **배포 시간 83% 단축 (90분 → 15분)** 및 Feature Flag 도입으로 롤백 시간 93% 단축
- **비즈니스:** B tv QR 로그인 기능 런칭으로 **신규 매출 월 1,000만원** 견인 및 260만 유저 데이터 Batch 처리

### **비엔디알에스(주)** (2023.11 ~ 2024.04)
- **성능 개선:** No-offset 적용으로 **조회 성능 85% 향상 (4초 → 0.6초)** & QueryDSL 전환으로 4건의 N+1 문제 해결
- **안정 운영:** ECS Rolling Update 기반 **24/7 무중단 서비스** 운영 및 롤백 프로세스 최적화 **(15분 → 3분)**
